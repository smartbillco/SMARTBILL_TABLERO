...
@Component({
  selector: 'CorrespondenceDashboard',
  templateUrl: './CorrespondenceDashboard.html',
  styleUrls: [ './CorrespondenceDashboard.css' ],
  encapsulation: ViewEncapsulation.None,
  imports: [FormsModule, CommonModule, HighlightModule,NgxDaterangepickerMd],  
  standalone: true
})

export class CorrespondenceDashboard implements OnInit {
