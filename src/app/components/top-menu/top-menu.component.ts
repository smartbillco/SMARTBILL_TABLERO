...
export class TopMenuComponent implements OnInit {
  menus: any[] = [];
	...
	ngOnInit() {
        ...
        /*
		this.appMenuService.getAppMenus(this.username).subscribe(data => {
			this.menus = data; // Asignamos el resultado a this.menus
			this.appMenuService.setMenuChange(data); // Opcional: Mantenemos esta línea si necesitas realizar esta acción también
		});*/
		this.menus = this.appMenuService.getAppMenus(); 
	}
